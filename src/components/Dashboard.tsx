  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Total Balance */}
        <button
          onClick={() => onMetricClick?.("totalBalance")}
          className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white w-full text-left"
        >
        ...
        {/* Goal Progress */}
        <button
          onClick={() => onMetricClick?.("goalProgress")}
          className="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white w-full text-left"
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-green-200 text-xs mt-1">
                {formatCurrency(inputs.goalAmount - metrics.totalBalance)}{" "}
                remaining
              </p>
            </div>
            <div className="p-3 bg-white/20 rounded-xl">
        ...
        {/* Risk Level */}
        <button
          onClick={() => onMetricClick?.("riskLevel")}
          className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white w-full text-left"
        >
          <div className="flex items-center justify-between">
            <div>
        ...
        {/* Years to Goal */}
        <button
          onClick={() => onMetricClick?.("yearsToGoal")}
          className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white w-full text-left"
        >
          <div className="flex items-center justify-between">
            <div>
